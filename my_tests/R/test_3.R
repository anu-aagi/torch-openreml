...
G_gen <- CovariancePropagation(list(z_gen = DesignMatrix(agridat::john.alpha$gen), g_gen = ScalarMatrix(n_gen)))
G_rep <- CovariancePropagation(list(z_rep = DesignMatrix(agridat::john.alpha$rep), g_gen = IdentityMatrix(n_rep)))
G_block <- CovariancePropagation(list(z_block = DesignMatrix(agridat::john.alpha$block), g_gen = ScalarMatrix(n_block)))
